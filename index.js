...
app.get("/", (req, res) => {
  res.send("<b>Bem vindx ao MetroShop!</b>");
});
...
app.post("/produtos", urlencodedParser, (req, res) => {
  ...
  var todosProdutos = "<table><tr><th>Id</th><th>Código</th><th>Nome</th><th>Preço</th><th>Marca</th><th>Alterar</th></tr>";
    ...
    app.get('/alteraProduto',(req,res)=>{
      ...
      Produto.findOne({
        ...
        .then(function (produto) {
          ...
          formulario += "Código do Produto:<br> <input type='text' name='codigo' id='codigo' value='"+produto.codigo+"'><br>";
          formulario += "Nome do Produto:<br> <input type='text' name='nome' id='nome' value='"+produto.nome+"'><br>";
          formulario += "Preço:<br> <input type='text' name='preco' id='preco' value='"+produto.preco+"'><br>";       
          formulario += "Marca:<br> <input type='text' name='marca' id='marca' value='"+produto.marca+"'><br>";
